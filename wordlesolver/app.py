...
app = Flask(__name__)
app.secret_key = "estamey21"
app.config["MYSQL_HOST"] = os.getenv("MYSQL_HOST_PYTHONANYWHERE", "localhost")
app.config["MYSQL_USER"] = os.getenv("MYSQL_USER_PYTHONANYWHERE", "root")
app.config["MYSQL_PASSWORD"] = os.getenv("MYSQL_PASSWORD_PYTHONANYWHERE", "")
app.config["MYSQL_DB"] = os.getenv("MYSQL_DB_PYTHONANYWHERE", "WordleSolver")
